...
function PageComponent(props) {
  ...
  return (
    ...
    >
      {/* <div className="opDiv absolute right-0 z-10">
        <Button type="default" size="small"><span className="fa fa-eraser" />清除信标</Button>
        <Button type="default" size="small"><span className="fa fa-map-marker" />关联信标</Button>
        <Button type="default" size="small"><span className="fa fa-eye" />已标注点</Button>
      </div> */}
      <div id="draggleDiv" style={{ position: 'absolute' }}>

        <img id="imgWrap" src={Panda} onMouseMove={DisplayCoord} style={{ position: 'absolute' }} onDoubleClick={handleDbClick} />
        <div
          className="absolute "
          style={{
